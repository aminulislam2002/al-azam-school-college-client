...
const AdminProfile = () => {
  ...
  return (
    <div className="bg-gray-100 min-h-screen p-4">
      <div className="bg-gray-800 h-52 rounded-lg mb-4"></div>

      <div className="flex justify-center items-center -mt-24">
        <img src={currentUser?.photo} alt="Profile" className="w-48 h-48 rounded-full border-4 border-blue-600" />
      </div>
      ...
      <div className="bg-white p-4 rounded-lg shadow">
        ...
        <p className="mb-2">
          <span className="text-gray-800 font-bold">Position:</span>
          <span className="text-black ms-1">{currentUser?.position}</span>
        </p>
        <p className="mb-2">
      ...
      <div className="flex justify-center items-center mt-10">
        <Link to={`update-admin-profile/${currentUser?._id}`}>
