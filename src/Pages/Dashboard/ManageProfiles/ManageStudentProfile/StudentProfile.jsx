    ...
    <div className="bg-gray-100 min-h-screen p-4">
      <div className="flex flex-col items-center justify-center space-y-4">
        <div className="relative">
          {currentUser.photo ? (
            <>
              <img src={currentUser?.photo} alt="Profile" className="w-40 h-40 rounded-full border-4 border-blue-600" />
      ...
      <div className="bg-white p-4 my-4 rounded-lg shadow">
        {currentUser?.class || currentUser?.roll ? (
          <p className="text-gray-800 font-semibold mb-2">
            Student in class {currentUser?.class || "N/A"} at Al-Azam High School and College. Roll no.
            {currentUser?.roll || "N/A"}
          </p>
        ) : (
          <p>Student in class N/A at Al-Azam High School and College. Roll no. N/A</p>
        )}
